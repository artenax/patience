...
const QList<Zug>& Zug::abhaengige_zuege() const
{
    return Abhaengige_zuege;
}


void Zug::fuege_abhaengigen_zug_an(const Zug& zug)
{
    Abhaengige_zuege.append(zug);
}


bool Zug::hat_abhaengige_zuege() const
{
    bool erg = false;

    if (Abhaengige_zuege.isEmpty() == false) erg = true;
